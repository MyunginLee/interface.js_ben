...
*/
			self.x = self.values[0] = acceleration.x;
			self.y = self.values[1] = acceleration.y;
			self.z = self.values[2] = acceleration.z;
  ...
  Interface.extend(this, {
    ...
    update : function(orientation) {
      ...
      _self.yaw    = _self.values[2] = _self.min + (orientation.alpha / 360 ) * _self.max ;
			_self.heading = _self.values[3]= _self.min + ((orientation.webkitCompassHeading  /  360 ) * _self.max );
		/*
